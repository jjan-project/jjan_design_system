...
export const Default: Story = {
  render: () => (
    ...
    >
      ...
      >
        <Typo appearance="header1">Header1</Typo>
        <Typo appearance="header2">header2</Typo>
        <Typo appearance="body1">body1</Typo>
        <Typo appearance="body2">body2</Typo>
        <Typo appearance="body3">body3</Typo>
      </div>
    </div>
  ),
};
